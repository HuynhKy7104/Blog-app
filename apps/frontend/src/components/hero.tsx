  ...
  return (
    <div className="bg-linear-to-br from-primary-600 to-secondary-600 text-primary-50 pt-24">
      <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
        {/* left col */}
        <div
          className="flex flex-col w-full justify-center items-start md:w-2/5 
        text-center md:text-left "
        >
          <p className="capitalize tracking-wide w-full">
            "Khám phá những góc nhìn sâu sắc, hướng dẫn và câu chuyện dành cho những
            tâm hồn ham học hỏi như bạn"
          </p>

          <h2 className="my-5 text-5xl font-bold leading-tight">
            Chào Mừng Đến Với Huỳnh Ký Blog
          </h2>

          <p className="capitalize leading-normal text-xl">
            Tham gia một cộng đồng phát triển mạnh mẽ nhờ việc học hỏi, sáng tạo và
